#!/usr/bin/env python
#
# curepy documentation build configuration file, created by
# cookiecutter
#
...
project_title = "curepy".replace("_", " ").title()
...
version = curepy.__version__
# The full version, including alpha/beta/rc tags.
release = curepy.__version__
...
man_pages = [(master_doc, "curepy", "curepy Documentation", [author], 1)]
