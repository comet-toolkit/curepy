#!/usr/bin/env python
#
# runpy_test documentation build configuration file, created by
# cookiecutter
#
...
project_title = "runpy_test".replace("_", " ").title()
...
version = runpy_test.__version__
# The full version, including alpha/beta/rc tags.
release = runpy_test.__version__
...
man_pages = [
    (master_doc, 'runpy_test',
     'runpy_test Documentation',
     [author], 1)
]
